...
class CreateNewWorkoutFragment : Fragment() {
    ...
    companion object {
         ...
         * *
         * @return A new instance of fragment CreateNewWorkoutFragment.
         */
        // TODO: Rename and change types and number of parameters
        fun newInstance(param1: String, param2: String): CreateNewWorkoutFragment {
            val fragment = CreateNewWorkoutFragment()
            val args = Bundle()
